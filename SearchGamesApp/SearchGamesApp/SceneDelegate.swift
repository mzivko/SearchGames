...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let selectedGenres = UserDefaults.standard.array(forKey: "selectedGenres") as? [Int]
        if let selectedGenres = selectedGenres {
            let gameListViewController = GameListViewController()
            gameListViewController.selectedGenres = selectedGenres
            ...
            navigationController.tabBarItem = UITabBarItem(title: "Games", image: UIImage(systemName: "gamecontroller"), tag: 0)
